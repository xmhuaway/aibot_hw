    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &AIbotBase::velCallback, this);
}

void AIbotBase::velCallback(const aibot_msgs::Velocities& vel)
{
    ...
    //linear speed from encodersAibotBase
